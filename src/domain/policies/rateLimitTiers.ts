/** The one route expensive enough to be worth limiting. `/api/health` is not. */
export type RateLimitedRoute = "search";
 ...
 * headroom, since not every run uses its full turn budget.
 *
