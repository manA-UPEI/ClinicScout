...
export async function POST(request: Request) {
  ...
  // call after call. What "one visitor" means now depends on whether they are
  // signed in — see domain/policies/rateLimitTiers.ts.
  const gate = await enforceRateLimit("call", request, requestId);
